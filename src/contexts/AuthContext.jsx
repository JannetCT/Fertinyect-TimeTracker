...
export function AuthProvider({ children }) {
  ...
  return (
    <AuthContext.Provider value={{ usuario, accessToken, cargando, login, logout, setUsuarioDesdeToken }}>
      {children}
    </AuthContext.Provider>
  )
}

// Mismo nombre que el hook anterior (useAuth) para que la migración de cada
// página sea un simple cambio de import, sin tocar el resto del código.
